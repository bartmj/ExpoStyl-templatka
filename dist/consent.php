<div id="consent-popup" class="consent-hidden">
        <p>Przeglądając naszą stronę internetową, wyrażasz zgodę na wykorzystywanie przez nas plików cookies.<a class="accept" onclick="alertDetails()">Szczegóły</a>
            <a id="accept" class="accept" href="#">Zaakceptuj</a>
        </p>
</div>
